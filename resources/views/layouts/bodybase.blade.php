...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <header class="header">
            ...
            <nav>
                <a href="{{ route('product.admin') }}" class="btn-primary">Painel Admin</a>
            </nav>
        </header>
        <main class="main">
            @yield('content-main')
        ...
        <footer class="footer-container">
            ...
            <div class="footer-column">
                ...
                <div class="social-midia">
                    ...
                    <a href="#">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRj6oJbQH2FzRWBgRjgOYQd2dTAFZE5GgSoYA&s">
                    </a>
                </div>
            </div>
        </footer>
